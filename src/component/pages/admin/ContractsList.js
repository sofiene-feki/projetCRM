...
import VoirContrat from './VoirContrat';
...
const ContractsList = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      { title: 'tel ', field: 'tel', width: 150 },
      { title: 'email ', field: 'email', width: 200 },
      { title: 'dateActivationElec ', field: 'dateActivationElec', width: 150 },
      {
        headerName: 'Actions',
        field: 'actions',
        type: 'actions',
        renderCell: (params) => <VoirContrat {...{ params }} />,
      },
    ],
    [rowId]
  );
